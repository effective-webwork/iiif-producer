...
public final class DomainConstants {
    ...
    public static String domainAttribution = "Provided by Leipzig University Library<br/>No Copyright - Public " +
            "Domain" + " Marked";
    public static String domainLogo = "https://iiifserv.ulb.tu-darmstadt.de/ubl-logo.png";
    public static String domainLicense = "https://creativecommons.org/publicdomain/mark/1.0/";
    static String baseUrl = "https://iiifserv.ulb.tu-darmstadt.de/";
    ...
    static String viewerUrl = "https://tudigit.ulb.tu-darmstadt.de/show/";
    static String katalogUrl = "http://orsprod.rz.uni-frankfurt.de/";
